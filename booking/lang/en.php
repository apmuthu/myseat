<?php
	...
	$lang["contact_form_intro"] = '<p>Dear Guest,<br/>
	to help you place a booking with us now, you can use this form below to make an online restaurant reservation right from your computer or mobile device. After completing the process, you will receive a confirmation email promptly. Should you wish to make a reservation for an event, tables larger than %s people or if you are unable to find the availability that you require, please contact us directly.</p>';
